        ...
        <div>
            <nav className="flex justify-center items-center w-full h-[7vh] mb-8 mt-2">
                <ul className="flex items-center justify-between w-full mt-8">
                    ...
                    <div className="flex space-x-8 ml-[10vw]">
                       ...
                       {/*  <li><a href="#" onClick={() => navigate("/contact")} className={`hover:border-b-2 border-blue-800 py-3 ${active === "contact" ? "border-b-2" : ""}`}>Contact</a></li>*/}
                        <li><a href="https://wa.link/q560iy" target="_blank" rel="noopener noreferrer" className={`hover:border-blue-800 hover:bg-white hover:text-blue-800 font-bold border-2 rounded-[32px] pl-4 pr-4 hover:border-b-2 border-white py-2 ${active === "orcamento" ? "border-b-2" : ""}`}>Orçamento</a></li>
