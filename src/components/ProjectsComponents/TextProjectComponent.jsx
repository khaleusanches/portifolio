...
function TextProjectComponent({nameProject}){
    ...
    return(
        <div className="w-full overflow-hidden md:overflow-auto md:w-[35vw] flex flex-col justify-between no-scrollbar md:h-full bg-gradient-to-b from-black to-gray-800 text-white">
            ...
            <a href="https://wa.link/q560iy" target="_blank" rel="noopener noreferrer" className="overflow-hidden bg-green-500 text-center hover:bg-green-600 w-[50vw] md:w-[20vw] pb-4 pt-2 m-auto mt-4 mb-4 rounded-full font-bold">
                Solicitar orçamento
            </a>
        </div>
    )
